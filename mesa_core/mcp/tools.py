...
from mesa_core.store import MAX_PAGE_SIZE, ProfileStore, _decode_cursor, _encode_cursor
...
def register_mesa_tools(
    ...
    *,
    ...
    if isinstance(adapter, str):
        if adapter == "fastmcp":
            from mesa_core.mcp.adapters.fastmcp import FastMCPRegistry

            registry = FastMCPRegistry(server)
        elif adapter == "raw_sdk":
            from mesa_core.mcp.adapters.raw_sdk import RawSDKRegistry
